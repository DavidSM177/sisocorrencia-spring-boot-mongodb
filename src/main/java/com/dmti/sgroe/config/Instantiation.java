...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Ocorrencia ocorrencia1 = new Ocorrencia(null, sdf.parse("01/12/2019"), "Briga de alunos", "alunos brigando na sala", new AuthorDTO(jhon));
		Ocorrencia ocorrencia2 = new Ocorrencia(null, sdf.parse("01/12/2019"), "Aluno Doente", "aluno doente", new AuthorDTO(jhon));
